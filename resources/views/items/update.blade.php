                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        @elseif($field->type === 'number')
                                            <input type="number" name="custom_fields[{{ $field->id }}]"
                                                class="form-control custom-field-input" value="{{ $field->value ?? '' }}"
                                                @if(!is_null($field->max_length)) max="{{ $field->max_length }}" @endif
                                                @if(!is_null($field->min_length)) min="{{ $field->min_length }}" @endif
                                                {{ $isRequired }} data-parsley-trigger="input">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex gap-2 mb-3">
                                        ...
                                        <button type="button" class="btn btn-primary" id="locate-me-btn" 
                                                style="background: var(--bs-primary); border: none; white-space: nowrap;">
                            ...
                            html += `<div class="col-md-6 mb-3">`;
                             ...
                             if (field.type === 'textbox') {
                                 ...
                                 if (maxLen || minLen) {
                                    ...
                                    const maxVal = field.max_length ? parseInt(field.max_length) : null;
                                    const minVal = field.min_length ? parseInt(field.min_length) : null;
                                    const maxAttr = maxVal !== null ? `max="${maxVal}"` : '';
                                    const minAttr = minVal !== null ? `min="${minVal}"` : '';
                                    html += `<input type="number" name="custom_fields[${field.id}]" class="form-control custom-field-input" ${isRequired} ${maxAttr} ${minAttr} value="${field.value ?? ''}" data-parsley-trigger="input">`;
