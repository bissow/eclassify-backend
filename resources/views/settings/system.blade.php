                    ...
                    <div class="card h-100 w-100">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-md-6">
                                    <label class="form-label ">{{ __('App Maintenance Mode') }}</label>
                                    <i class="fa fa-info-circle" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Temporary disable mobile app.') }}" aria-label="{{ __('Temporary disable mobile app.') }}"></i>
                                    <div class="form-check form-switch">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        {{-- Place API Key --}}
                        <div class="form-group col-lg-6" id="s3_div" style="display: none">
                        ...
                        {{-- Google Map Key --}}
                        <div class="form-group col-lg-6" id="google_map_key_div" style="display: none">
                            <label for="google_map_key" class="form-label">{{ __('Google Map Key') }}</label>
                            <input class="form-control" type="text" name="google_map_key" id="google_map_key" value="{{ $settings['google_map_key'] ?? '' }}">
