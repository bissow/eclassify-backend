            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6 col-lg-3 d-flex align-items-center justify-content-center flex-column">
                            <label class="form-label">{{ __('Web Maintenance Mode') }}
                            ...
                            <div class="form-check form-switch">
                                <input type="hidden" name="web_maintenance_mode" value="0">
                                <input class="form-check-input" type="checkbox" id="web_maintenance_mode" name="web_maintenance_mode" value="1" {{ isset($settings['web_maintenance_mode']) && $settings['web_maintenance_mode'] == 1 ? 'checked' : '' }}>
                                <label class="form-check-label" for="web_maintenance_mode">
                                    {{ __('On / Off') }}
                                </label>
                            </div>
                        </div>
