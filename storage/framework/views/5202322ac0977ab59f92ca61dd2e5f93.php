...
<?php if($firebaseWebConfigured ?? false): ?>
...
<script type="text/javascript" src="<?php echo e(asset('assets/extensions/jquery-ui/jquery.ui.touch-punch.min.js')); ?>"></script>
...
<script type="text/javascript">
    ...
    window.ActionIcons = {
        edit: <?php echo json_encode(\App\Services\BootstrapTableService::icon('edit'), 15, 512) ?>,
        delete: <?php echo json_encode(\App\Services\BootstrapTableService::icon('delete'), 15, 512) ?>,
        view: <?php echo json_encode(\App\Services\BootstrapTableService::icon('view'), 15, 512) ?>,
    };
...
<script>
    ...
    (function() {
        ...
        const fcmWebConfig = <?php echo json_encode($firebaseWebConfig ?? [], 15, 512) ?>;
        let messaging = null;
        ...
        function registerFcmToken(token) {
            if (!token) return;
            $.ajax({
                url: '<?php echo e(route("admin-chat.register-fcm-token")); ?>',
                method: 'POST',
...
<?php /**PATH C:\Users\nilan\Downloads\eclassify-backend\resources\views/layouts/footer_script.blade.php ENDPATH**/ ?>