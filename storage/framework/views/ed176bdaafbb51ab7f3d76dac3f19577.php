                        ...
                        <div class="row g-0 h-100 m-0 w-100">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-12 h-100 px-2 pb-3 pb-md-0">
                                ...
                                <div class="p-3 flex-shrink-0 d-flex justify-content-between align-items-center panel-head">
                                    <h5 class="mb-0 panel-title"><?php echo e(__('Products')); ?></h5>
                                    <a href="javascript:void(0)" class="text-muted admin-chat-refresh-icon" id="refresh-products-btn" title="<?php echo e(__('Refresh Products')); ?>">
                                ...
                                <div class="p-3 border-bottom flex-shrink-0">
                                    <div class="input-group admin-chat-search-group">
                                        ...
                                        <input type="text" class="form-control" id="product-search" placeholder="<?php echo e(__('Search...')); ?>">
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-4 col-12 h-100 px-2 pb-3 pb-md-0">
                                ...
                                <div class="p-3 border-bottom flex-shrink-0 d-flex justify-content-between align-items-center panel-head">
                                    <div>
                                        <h5 class="mb-0 panel-title"><?php echo e(__('Chats')); ?></h5>
                                        <small class="text-muted chat-summary" id="chats-summary">0 <?php echo e(__('Message')); ?>, 0 <?php echo e(__('Unread')); ?></small>
                                    </div>
                                    <div class="d-flex align-items-center gap-2">
                                        <a href="javascript:void(0)" class="text-muted admin-chat-refresh-icon" id="refresh-chats-btn" title="<?php echo e(__('Refresh Chats')); ?>">
                                            <i class="fas fa-sync-alt"></i>
                                        </a>
                                        <a href="javascript:void(0)" class="text-muted small" id="chat-select-toggle-btn" onclick="window.adminChatToggleSelectMode()" title="<?php echo e(__('Select')); ?>">
                                ...
                                <div class="p-2 border-bottom flex-shrink-0">
                                    <div class="input-group admin-chat-search-group">
                                        <span class="input-group-text"><i class="fas fa-search"></i></span>
                                        <input type="text" class="form-control" id="chat-search" placeholder="<?php echo e(__('Search...')); ?>">
                                    </div>
                                </div>
                                <div id="chats-list" class="flex-grow-1 chat-scrollable chat-scroll-hide">
                                    <div class="text-center p-4 mt-5">
                                        <img src="<?php echo e(asset('assets/images/chats/chat-section-emtpy.png')); ?>" alt="<?php echo e(__('Select a item to chat')); ?>" class="admin-chat-empty-icon">
                                        <h5 class="admin-chat-empty-title"><?php echo e(__('Select a item to chat')); ?></h5>
                                        <p class="text-muted admin-chat-empty-subtitle"><?php echo e(__('Pick a item from the list to view its chats.')); ?></p>
                                    </div>
                                </div>
                                <div class="p-2 border-top flex-shrink-0 chat-select-actions" id="chat-select-actions">
                                    <button class="btn btn-sm btn-outline-secondary flex-grow-1" onclick="window.adminChatToggleSelectMode()"><?php echo e(__('Cancel')); ?></button>
                                    <button class="btn btn-sm btn-danger flex-grow-1" id="chat-delete-selected-btn" onclick="window.adminChatDeleteSelectedChats()" disabled><?php echo e(__('Delete')); ?> (<span id="chat-selected-count">0</span>)</button>
                                </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-5 col-lg-5 col-md-4 col-12 h-100 px-2 pb-3 pb-md-0">
                                ...
                                <?php if(!$firebaseWebConfigured): ?>
                                <div class="alert alert-info m-3 mb-0" role="alert">
                                    <i class="fas fa-info-circle me-2"></i>
                                    <strong><?php echo e(__('Live Chat Setup Required')); ?>:</strong> 
                                    <?php echo e(__('To enable real-time chat refresh, please configure Firebase web settings.')); ?>

                                    <a href="<?php echo e(route('settings.firebase.index')); ?>" class="alert-link ms-1"><?php echo e(__('Go to Firebase Settings')); ?></a>
                                    <div class="small mt-2">
                                        <?php echo e(__('Required fields: Api Key, Auth Domain, Project Id, Storage Bucket, Messaging Sender Id, App Id, VAPID Key')); ?>

                                    </div>
                                </div>
                                <?php elseif(!empty($firebaseWebConfig['vapidKey']) == false): ?>
                                <div class="alert alert-warning m-3 mb-0" role="alert">
                                    <i class="fas fa-exclamation-triangle me-2"></i>
                                    <strong><?php echo e(__('VAPID Key Missing')); ?>:</strong> 
                                    <?php echo e(__('VAPID key is required for FCM token. Please add it in Firebase Settings.')); ?>

                                    <a href="<?php echo e(route('settings.firebase.index')); ?>" class="alert-link ms-1"><?php echo e(__('Go to Firebase Settings')); ?></a>
                                    <div class="small mt-2">
                                        <?php echo e(__('Get VAPID key from: Firebase Console → Project Settings → Cloud Messaging → Web Push certificates')); ?>
                                ...
                                <div class="p-3 border-bottom d-none justify-content-between align-items-center flex-shrink-0 chat-user-head" id="chat-header">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li><a class="dropdown-item" href="javascript:void(0)" onclick="window.adminChatToggleMessageSelectMode()"><i class="fas fa-check-square me-2"></i><?php echo e(__('Select Messages')); ?></a></li>
                                            <li id="block-user-menu-item"><a class="dropdown-item text-warning" href="javascript:void(0)" onclick="window.adminChatBlockUser()"><i class="fas fa-ban me-2"></i><?php echo e(__('Block User')); ?></a></li>
                                            <li id="unblock-user-menu-item" style="display: none;"><a class="dropdown-item text-success" href="javascript:void(0)" onclick="window.adminChatUnblockUser()"><i class="fas fa-check-circle me-2"></i><?php echo e(__('Unblock User')); ?></a></li>
                                            <li><hr class="dropdown-divider"></li>
                                            <li><a class="dropdown-item text-danger" href="javascript:void(0)" onclick="window.adminChatDeleteChat()"><i class="fas fa-trash-alt me-2"></i><?php echo e(__('Delete Chat')); ?></a></li>
                                        </ul>
                                    </div>
                                    </div>
                                </div>
                                <div id="chat-messages" class="flex-grow-1 chat-scrollable chat-messages-container d-flex flex-column align-items-center justify-content-center chat-scroll-hide">
                                    ...
                                    <div id="blocked-user-banner" class="alert alert-warning w-100 mb-2" style="display: none;" role="alert">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                ...
                                                <strong><?php echo e(__('You have blocked this user')); ?></strong>
                                                <p class="mb-0 small">
                                                    <?php echo e(__('Click')); ?> <a href="javascript:void(0)" onclick="window.adminChatUnblockUser()" class="fw-bold text-decoration-underline"><?php echo e(__('here')); ?></a> <?php echo e(__('to unblock')); ?>
                                    ...
                                    <div class="text-center p-4 chat-empty-state">
                                        <img src="<?php echo e(asset('assets/images/chats/message-section-empty.png')); ?>" alt="<?php echo e(__('No conversation selected yet!')); ?>" class="admin-chat-msg-empty-icon">
                                        <h4 class="admin-chat-msg-empty-title"><?php echo e(__('No conversation selected yet!')); ?></h4>
                                        <p class="text-muted mt-2 admin-chat-msg-empty-subtitle"><?php echo e(__('Pick a conversation from the sidebar to view details and messages.')); ?></p>
                                    </div>
                                </div>
                                <div class="p-2 border-top flex-shrink-0 msg-select-actions" id="msg-select-actions">
                                    <div class="d-flex gap-2">
                                        <button class="btn btn-sm btn-outline-secondary flex-grow-1" onclick="window.adminChatToggleMessageSelectMode()"><?php echo e(__('Cancel')); ?></button>
                                        <button class="btn btn-sm btn-danger flex-grow-1" id="msg-delete-selected-btn" onclick="window.adminChatDeleteSelectedMessages()" disabled><?php echo e(__('Delete')); ?> (<span id="msg-selected-count">0</span>)</button>
                                    </div>
                                </div>
                                <div class="p-3 border-top flex-shrink-0" id="chat-input-container">
                                    ...
                                    <div id="file-preview-bar">
                                        <button type="button" id="cancel-file-btn" class="file-preview-cancel-btn" title="<?php echo e(__('Remove attachment')); ?>">
                                            <i class="fas fa-times"></i>
                                        </button>
                                        <!-- Row 1: Full Image Preview (not clipped) -->
                                        <div class="file-preview-row-media">
                                            <img id="file-preview-thumb" src="" alt="<?php echo e(__('Preview')); ?>" style="display: none;">
                                        </div>
                                    ...
                                    <form id="send-message-form">
                                        <div class="input-group chat-compose-group">
                                            <button type="button" class="btn btn-outline-secondary compose-icon-btn" id="attach-file-btn" title="<?php echo e(__('Attach file')); ?>">
                                                <?php if(file_exists(public_path('assets/images/chats/attach-file-icon.png'))): ?> <img src="<?php echo e(asset('assets/images/chats/attach-file-icon.png')); ?>" alt="<?php echo e(__('Attach file')); ?>"> <?php else: ?> <i class="fas fa-paperclip"></i> <?php endif; ?>
                                            </button>
                                            <!-- Record Audio Button -->
                                            <button type="button" class="btn btn-outline-secondary compose-icon-btn" id="record-audio-btn" title="<?php echo e(__('Record Audio')); ?>">
                                            ...
                                            <div id="recording-ui" class="d-none align-items-center justify-content-between flex-grow-1 bg-light rounded px-2">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <button type="button" class="btn btn-sm btn-link text-secondary" id="pause-recording-btn" title="<?php echo e(__('Pause')); ?>">
                                                        <i class="fas fa-pause"></i>
                                                    </button>
                                                    <button type="button" class="btn btn-sm btn-link text-danger" id="stop-recording-btn" title="<?php echo e(__('Stop')); ?>">
                                                        <i class="fas fa-stop"></i>
                                                    </button>
                                                    <button type="button" class="btn btn-sm btn-link text-secondary" id="cancel-recording-btn" title="<?php echo e(__('Cancel')); ?>">
                                                        <i class="fas fa-times"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            ...
                                            <div id="audio-preview-ui" class="d-none align-items-center flex-grow-1">
                                                ...
                                                <button type="button" class="btn btn-sm btn-link text-danger" id="delete-recorded-audio-btn" title="<?php echo e(__('Delete')); ?>">
                                                    <i class="fas fa-trash"></i>
                                                </button>
                                                <button type="button" class="btn btn-primary compose-send-btn" id="send-recorded-audio-btn" title="<?php echo e(__('Send')); ?>">
                                                    <?php if(file_exists(public_path('assets/images/chats/send-icon.png'))): ?> <img src="<?php echo e(asset('assets/images/chats/send-icon.png')); ?>" alt="<?php echo e(__('Send')); ?>"> <?php else: ?> <i class="fas fa-paper-plane"></i> <?php endif; ?>
                                                </button>
                                            </div>
                                            <!-- Message Input (hidden when recording or preview) -->
                                            <input type="text" class="form-control" id="message-input" placeholder="<?php echo e(__('Type Messages')); ?>">
...
<?php $__env->startSection('js'); ?>
    ...
    <script>
        (function() {
            ...
            const config = {
                currentUserId: <?php echo e($adminUser->id ?? Auth::id()); ?>,
                placeholderImage: '<?php echo e(asset("assets/images/logo/placeholder.png")); ?>',
                routes: {
                    products: '<?php echo e(route("admin-chat.products")); ?>',
                    chatList: '<?php echo e(route("admin-chat.chat-list")); ?>',
                    messages: '<?php echo e(route("admin-chat.messages")); ?>',
                    sendMessage: '<?php echo e(route("admin-chat.send-message")); ?>',
                    deleteChat: '<?php echo e(route("admin-chat.delete-chat")); ?>',
                    deleteMessages: '<?php echo e(route("admin-chat.delete-messages")); ?>',
                    blockUser: '<?php echo e(route("admin-chat.block-user")); ?>',
                    unblockUser: '<?php echo e(route("admin-chat.unblock-user")); ?>',
                    linkPreview: '<?php echo e(route("admin-chat.link-preview")); ?>'
                },
                translations: {
                    noProducts: '<?php echo e(__("No products found")); ?>',
                    noChats: '<?php echo e(__("No chats found")); ?>',
                    noMessages: '<?php echo e(__("No messages yet")); ?>',
                    selectChat: '<?php echo e(__("Select a chat to start messaging")); ?>',
                    unknownUser: '<?php echo e(__("Unknown User")); ?>',
                    failedProducts: '<?php echo e(__("Failed to load products")); ?>',
                    failedChats: '<?php echo e(__("Failed to load chats")); ?>',
                    failedMessages: '<?php echo e(__("Failed to load messages")); ?>',
                    failedSend: '<?php echo e(__("Failed to send message")); ?>',
                    invalidFileType: '<?php echo e(__("The file must be a file of type: jpg, jpeg, png.")); ?>',
                    selectChatFirst: '<?php echo e(__("Please select a chat")); ?>',
                    message: '<?php echo e(__("Message")); ?>',
                    unread: '<?php echo e(__("Unread")); ?>',
                    noChatFoundTitle: '<?php echo e(__("No Chat Found")); ?>',
                    noChatFoundDesc: '<?php echo e(__("It Look\'s Like there is no Chat Available")); ?>',
                    noMessageSelectedTitle: '<?php echo e(__("No conversation selected yet!")); ?>',
                    noMessageSelectedDesc: '<?php echo e(__("Pick a conversation from the sidebar to view details and messages.")); ?>',
                    confirmDeleteChat: '<?php echo e(__("Are you sure you want to delete this chat?")); ?>',
                    confirmDeleteMessage: '<?php echo e(__("Are you sure you want to delete this message?")); ?>',
                    chatDeleted: '<?php echo e(__("Chat Deleted Successfully")); ?>',
                    messageDeleted: '<?php echo e(__("Message Deleted Successfully")); ?>',
                    failedDeleteChat: '<?php echo e(__("Failed to delete chat")); ?>',
                    failedDeleteMessage: '<?php echo e(__("Failed to delete message")); ?>',
                    confirmDeleteSelectedChats: '<?php echo e(__("Are you sure you want to delete the selected chats?")); ?>',
                    confirmDeleteSelectedMessages: '<?php echo e(__("Are you sure you want to delete the selected messages?")); ?>',
                    noChatsSelected: '<?php echo e(__("No chats selected")); ?>',
                    noMessagesSelected: '<?php echo e(__("No messages selected")); ?>',
                    loadingPreview: '<?php echo e(__("Loading preview...")); ?>'
                },
                images: {
                    emptyChats: '<?php echo e(asset("assets/images/chats/chat-section-emtpy.png")); ?>',
                    emptyMessages: '<?php echo e(asset("assets/images/chats/message-section-empty.png")); ?>'
                },
                firebaseWebConfig: <?php echo json_encode($firebaseWebConfig ?? [], 15, 512) ?>,
                firebaseWebConfigured: <?php echo e($firebaseWebConfigured ? 'true' : 'false'); ?>
            ...
            function renderMessages(messages) {
                ...
                if (isBlocked) {
                    ...
                    const inlineBanner = `<div class="blocked-inline-banner text-center py-2">
                        <span class="badge bg-warning text-dark py-2 px-3">
                            ...
                            <?php echo e(__('You have blocked this user')); ?>. 
                            <a href="javascript:void(0)" onclick="window.adminChatUnblockUser()" class="text-decoration-underline text-dark fw-bold"><?php echo e(__('Click here to unblock')); ?></a>
                        </span>
                    </div>`;
                ...
                // Buyer's offer bubble (received side, shown at top like the mobile app)
                let offerHtml = '';
                if (currentOffer && (currentOffer.amount_formatted || currentOffer.amount)) {
                    const offerAmount = currentOffer.amount_formatted || currentOffer.amount;
                    offerHtml = `
                        <div class="d-flex justify-content-start mb-3">
                            <div class="admin-chat-offer-bubble">
                                <div class="admin-chat-offer-label"><?php echo e(__('Offer')); ?></div>
                                <div class="admin-chat-offer-amount">${escapeHtml(String(offerAmount))}</div>
                            </div>
                        </div>
                    `;
                }
                ...
                messages.forEach(function(message) {
                    ...
                    let messageHtml = '';
                    if (isSent) {
                        const userProfile = '<?php echo e(Auth::user()->profile); ?>';
                        ...
                        const deleteBtn = !messageSelectMode ? `<button class="btn btn-sm btn-link text-danger admin-chat-msg-delete-btn" onclick="window.adminChatDeleteMessage(${message.id})" title="<?php echo e(__('Delete')); ?>"><i class="fas fa-trash-alt"></i></button>` : '';
                        messageHtml = `
                            <div class="d-flex justify-content-end mb-3 align-items-end admin-chat-msg-row" ${messageSelectMode ? `onclick="window.adminChatToggleMessageSelection(${message.id})"` : ''}>
                                ...
                                ${userProfile ? `<img src="${userProfile}" alt="${escapeHtml(userName)}" class="rounded-circle me-2 chat-msg-avatar" onerror="this.src='${config.placeholderImage}'">` : `<span class="me-2">${generateInitialAvatar('<?php echo e(Auth::user()->name); ?>', 30)}</span>`}
                            </div>
                        `;
                    } else {
                        messageHtml = `
            ...
            function composeLinkPreviewCardHtml(preview, url) {
                ...
                return `
                    <div class="compose-link-preview-card" data-preview-url="${escapeHtml(url)}">
                        ...
                        <button type="button" class="compose-link-preview-remove-btn" id="compose-link-preview-remove" title="<?php echo e(__('Remove preview')); ?>">
                            <i class="fas fa-times"></i>
                        </button>
                    </div>
                `;
            ...
            function formatDateLabel(dateString) {
                ...
                if (msgKey === todayKey) return '<?php echo e(__('Today')); ?>';
                if (msgKey === yesterdayKey) return '<?php echo e(__('Yesterday')); ?>';
            ...
            window.adminChatBlockUser = function() {
                ...
                Swal.fire({
                    title: '<?php echo e(__("Block User")); ?>',
                    text: '<?php echo e(__("Are you sure you want to block this user? You won\'t be able to send messages until you unblock them.")); ?>',
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonText: '<?php echo e(__("Block")); ?>',
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            success: function(response) {
                                if (response.error === false) {
                                    showSuccessToast(response.message || '<?php echo e(__("User blocked successfully")); ?>');
                                    loadMessages(selectedChatId, false);
                                } else {
                                    showErrorToast(response.message || '<?php echo e(__("Failed to block user")); ?>');
                                }
                            },
                            error: function(xhr) {
                                const error = xhr.responseJSON?.message || '<?php echo e(__("Failed to block user")); ?>';
                                showErrorToast(error);
                            }
                        });
                    }
            ...
            window.adminChatUnblockUser = function() {
                ...
                Swal.fire({
                    title: '<?php echo e(__("Unblock User")); ?>',
                    text: '<?php echo e(__("Are you sure you want to unblock this user? You will be able to send messages again.")); ?>',
                    icon: 'question',
                    showCancelButton: true,
                    confirmButtonText: '<?php echo e(__("Unblock")); ?>',
                    cancelButtonText: '<?php echo e(__("Cancel")); ?>',
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            success: function(response) {
                                if (response.error === false) {
                                    showSuccessToast(response.message || '<?php echo e(__("User unblocked successfully")); ?>');
                                    loadMessages(selectedChatId, false);
                                } else {
                                    showErrorToast(response.message || '<?php echo e(__("Failed to unblock user")); ?>');
                                }
                            },
                            error: function(xhr) {
                                const error = xhr.responseJSON?.message || '<?php echo e(__("Failed to unblock user")); ?>';
                                showErrorToast(error);
                            }
                        });
                    }
            ...
            async function startRecording() {
                try {
                    ...
                    showErrorToast('<?php echo e(__("Could not access microphone. Please ensure microphone permission is granted.")); ?>');
                }
            }
            ...
            function togglePauseRecording() {
                ...
                if (isPaused) {
                    ...
                    $('#pause-recording-btn').html('<i class="fas fa-pause"></i>').attr('title', '<?php echo e(__("Pause")); ?>');
                    isPaused = false;
                } else {
                    audioRecorder.pause();
                    $('#pause-recording-btn').html('<i class="fas fa-play"></i>').attr('title', '<?php echo e(__("Resume")); ?>');
                    isPaused = true;
                }
            }
