...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['name', 'size' => 40]));
...
foreach (array_filter((['name', 'size' => 40]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php endif; ?>
<?php /**PATH C:\Users\nilan\Downloads\eclassify-backend\resources\views/components/avatar-initial.blade.php ENDPATH**/ ?>