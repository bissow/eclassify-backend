                ...
                if ($val !== null && $val !== '' && !(is_array($val) && empty($val))) {
                    if ($field->type === 'textbox') {
                        ...
                        if (!is_numeric($val)) {
                            ...
                            if (!is_null($field->min_length) && floatval($val) < $field->min_length) {
                                $customFieldErrors["custom_fields.$fieldId"] = "The $fieldLabel field must be at least {$field->min_length}.";
                            }
                            if (!is_null($field->max_length) && floatval($val) > $field->max_length) {
                                $customFieldErrors["custom_fields.$fieldId"] = "The $fieldLabel field must not exceed {$field->max_length}.";
                            }
                        }
                    }
                }
